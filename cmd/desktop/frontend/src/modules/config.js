...
export async function addEndpoint(name, url, key, authMode, transformer, model, remark, extraBody) {
    await window.go.main.App.AddEndpoint(name, url, key, authMode, transformer, model, remark || '', extraBody || '');
}

export async function updateEndpoint(index, name, url, key, authMode, transformer, model, remark, extraBody) {
    await window.go.main.App.UpdateEndpoint(index, name, url, key, authMode, transformer, model, remark || '', extraBody || '');
}
